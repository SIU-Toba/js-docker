...
# https://stackoverflow.com/questions/49854237/is-xxmaxramfraction-1-safe-forduction-in-a-containered-environment
...
execute_buildomatic() {
  ...
  for i in $@; do
    # Default buildomatic deploy-webapp target attempts to remove
